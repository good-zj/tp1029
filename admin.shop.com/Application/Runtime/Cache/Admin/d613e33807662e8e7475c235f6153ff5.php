...
<div class="main-div">
    <form method="post" action="<?php echo U('edit');?>?id="<?php echo ($rows["id"]); ?> enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea  name="intro" cols="60" rows="4"  ><?php echo ($rows["intro"]); ?></textarea>
                </td>
            </tr>
            <tr>
...
<script src="http://admin.shop.com/Public/js/jquery.min.js">
</script>
<script type="text/javascript">
    $(function(){
        $('input[name=status]').val([<?php echo ((isset($rows["status"]) && ($rows["status"] !== ""))?($rows["status"]):1); ?>]);
    });
</script>
<div id="footer">
